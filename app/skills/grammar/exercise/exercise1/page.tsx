...
export default function Exercise1Page() {
  ...
  const questions = [
    {
      number: 1,
      text: "___ は 公園 です。 (This is a park)",
      options: ["ここ", "そこ", "あそこ"],
      correctAnswer: "ここ",
    },
    {
      number: 2,
      text: "あなた の 本 は ___ です。 (Your book is over there)",
      options: ["ここ", "そこ", "あそこ"],
      correctAnswer: "あそこ",
    },
    {
      number: 3,
      text: "___ は トイレ です。 (The restroom is over there)",
      options: ["ここ", "そこ", "あそこ"],
      correctAnswer: "あそこ",
    },
    {
      number: 4,
      text: "___ は 私 の 家 です。 (This is my house)",
      options: ["ここ", "そこ", "あそこ"],
      correctAnswer: "ここ",
    },
    {
      number: 5,
      text: "My friend asked, 「トイレ は どこ です か？」 I answered, 「トイレ は ___ です 」.",
      options: ["この", "あそこ", "その", "あの"],
      correctAnswer: "あそこ",
    },
  ]
    ...
    <main className="min-h-screen bg-gray-50 pb-12">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Exercise: Lesson 1</h1>
          <p className="text-gray-600">Demonstratives (ここ, そこ, あそこ)</p>
        </div>
          ...
          {questions.map((question) => (
            <div
              ...
              className={`bg-white rounded-xl shadow-sm border p-6 transition-all ${
                showResults
                  ? answers[question.number] === question.correctAnswer
        ...
        {showResults && (
          <div className="mt-8 flex justify-center">
            <button
              onClick={() => router.push("/skills/grammar/exercise")}
