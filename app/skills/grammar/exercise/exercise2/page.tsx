...
export default function Exercise2Page() {
  ...
  const questions = [
    {
      number: 1,
      text: "___ は 本 です。 (This is a book)",
      options: ["これ", "それ", "あれ"],
      correctAnswer: "これ",
    },
    {
      number: 2,
      text: "___ は 辞書 です。 (That is a dictionary)",
      options: ["これ", "それ", "あれ"],
      correctAnswer: "それ",
    },
    {
      number: 3,
      text: "___ は 車 です か。 (Is that a car over there?)",
      options: ["これ", "それ", "あれ"],
      correctAnswer: "あれ",
    },
    {
      number: 4,
      text: "私 の ペン は ___ です。 (My pen is this one)",
      options: ["これ", "それ", "あれ"],
      correctAnswer: "これ",
    },
    {
      number: 5,
      text: "先生 の カバン は ___ です。 (The teacher's bag is that one)",
      options: ["これ", "それ", "あれ"],
      correctAnswer: "それ",
    },
  ];
    ...
    <main className="min-h-screen bg-gray-50 pb-12">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Exercise: Lesson 2</h1>
          <p className="text-gray-600">Demonstratives (これ, それ, あれ)</p>
        </div>
